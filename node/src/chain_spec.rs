// use hex_literal::hex;
use node_potw_runtime::{
	AccountId, BabeConfig, BalancesConfig, RuntimeGenesisConfig, GrandpaConfig, Signature, SudoConfig,
	SystemConfig, WASM_BINARY, BABE_GENESIS_EPOCH_CONFIG, SessionConfig, StakingConfig, SessionKeys, ProofOfTangibleWorkConfig,
...
pub fn development_config() -> Result<ChainSpec, String> {
	...
	let hash_task: [u8; 16] =  [0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0];
...
fn testnet_genesis(
	...
	let mut accs = endowed_accounts.clone();
	...
	RuntimeGenesisConfig {
		...
		proof_of_tangible_work: ProofOfTangibleWorkConfig {
			initial_tasks: initial_tasks,
			initial_members: balances
		},
	}
}
